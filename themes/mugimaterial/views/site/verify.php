...
$this->breadcrumbs=array(
  ...
  <?php $form=$this->beginWidget('CActiveForm', array(
    'id'=>'forgot-form',
      ...
      <?php echo $form->errorSummary($verify, null, null, array('class' => 'alert alert-danger alert-bold-border fade in alert-dismissable')); ?>
    ...
    <div class="form-container">
      <form class="form-horizontal" action="javascript:;">
        ...
        <div class="md-input-container md-float-label">
          ...
          <?php echo $form->textField($verify,'privatekey', array('class' => 'md-input')); ?>
          <?php echo $form->labelEx($verify,'privatekey'); ?>
