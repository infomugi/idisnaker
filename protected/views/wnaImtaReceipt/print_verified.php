...
<div class="kotak">
	<div class="line3"></div>
	<div class="line2"></div>
	<div class="judul"><U>HASIL VERIFIKASI BERKAS IMTA</U></div>
	<H3><center><?php echo $model->Company->name; ?> an. <?php echo $model->name; ?></center></H3>
	<BR>
	</div>
				...
				<p>
					<div class="jadwal">
						<table>
							...
							<?php if($model->letter_stuffing_imta==0): ?>
								<tr>
									<td width="2%">2.</td>
							...
							<?php if($model->letter_passport==0): ?>
								<tr>
									<td width="2%">5.</td>
							...
							<?php if($model->letter_tka_existence==0): ?>
								<tr>
									<td width="2%">7.</td>
							...
							<?php if($model->letter_permission==0): ?>
								<tr>
									<td width="2%">8.</td>
							...
							<?php if($model->letter_employment==0): ?>
								<tr>
									<td width="2%">11.</td>
							...
							<?php if($model->letter_appointment_tki==0): ?>
								<tr>
									<td width="2%">12.</td>
							...
							<?php if($model->letter_realization_of_training==0): ?>
								<tr>
									<td width="2%">13.</td>
							...
							<?php if($model->letter_organizational_structure==0): ?>
								<tr>
									<td width="2%">14.</td>
							...
							<?php if($model->letter_permit_domicile==0): ?>
								<tr>
									<td width="2%">15.</td>
							...
							<?php if($model->letter_insurance_tka==0): ?>
								<tr>
									<td width="2%">16.</td>
