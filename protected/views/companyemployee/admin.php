...
$this->breadcrumbs=array(
	...
	$this->pageTitle='Manage CompanyEmployee';
	?>
 ...
 ?>
	...
	<span class="hidden-xs">
		...
		<?php echo CHtml::link('Add CompanyEmployee',
 array('create'),
 array('class' => 'btn btn-primary btn-flat'));
 ?>
		<?php echo CHtml::link('List CompanyEmployee',
 array('index'),
 array('class' => 'btn btn-primary btn-flat'));
 ?>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title"><strong>View</strong> CompanyEmployee</h4>
					</div>
					<!-- Popup Content -->
