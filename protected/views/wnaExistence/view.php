...
$this->pageTitle='Detail WNA Existence';
		...
		<?php echo CHtml::link('<i class="fa fa-tasks"></i>',
			...
			<?php echo CHtml::link('<i class="fa fa-table"></i>',
				...
				<?php echo CHtml::link('<i class="fa fa-edit"></i>', 
					array('update', 'id'=>$model->id_wna_existence,
						), array('class' => 'btn btn-info btn-flat', 'title'=>'Edit Keberadaan TKA'));
						?>
						<?php echo CHtml::link('<i class="fa fa-remove"></i>', 
							array('delete', 'id'=>$model->id_wna_existence,
													...
													<?php echo CHtml::link('Delete', 
														array('delete', 'id'=>$model->id_wna_existence,
															...
															<?php echo CHtml::link('Print', 
																array('print', 'id'=>$model->id_wna_existence,
																					...
																					<div class="tab-pane active" id="myfiles">
																						<div class="row">
																							<div class="col-md-12">
																								...
																								<H3><i class="fa fa-check-square"></i> Surat Keterangan <span class="hidden-xs">Serial : <?php echo $model->no_registration; ?></span></H3>
