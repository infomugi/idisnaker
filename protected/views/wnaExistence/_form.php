...
<!-- 			<div class="form-group">
        ...
        $("#WnaExistence_created_date").mask("99/99/9999",{placeholder:"dd/mm/yyyy"});
        $("#WnaExistence_date_report").mask("99/09/2016",{placeholder:"dd/mm/yyyy"});
        $("#WnaExistence_birth").mask("99/99/9999",{placeholder:"dd/mm/yyyy"});
        $("#WnaExistence_expired_date").mask("99/99/9999",{placeholder:"dd/mm/yyyy"});
        $("#WnaExistence_no_registration").mask("999/PTK/<?php echo WnaExistence::model()->romawi(substr(date('m'),1)); ?>/<?php echo date('Y'); ?>");
			   // $("#WnaExistence_no_rptka").mask("KEP 999/99999/RPTKA-BPM/2019");
			   // $("#WnaExistence_no_imta").mask("KEP 99999/IMTA/BPMP/2019");
			   // $("#WnaExistence_no_passport").mask("*********");
			});     	
		</script>
