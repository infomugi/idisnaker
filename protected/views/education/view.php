...
$this->breadcrumbs=array(
	...
	$this->pageTitle='Detail Education';
	?>
 ...
 array('class' => 'btn btn-primary btn-flat','title'=>'Manage Education'));
	 ...
	 array('update', 'id'=>$model->id_education,
		), array('class' => 'btn btn-info btn-flat', 'title'=>'Edit Education'));
 ?>
		<?php echo CHtml::link('<i class="fa fa-remove"></i>', 
	 array('delete', 'id'=>$model->id_education,
		),  array('class' => 'btn btn-danger btn-flat', 'title'=>'Hapus Education'));
 ?>
