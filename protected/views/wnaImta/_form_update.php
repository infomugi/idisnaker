...
<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			...
			// 	));
				?>
				<?php echo $form->textField($model,'date_report',array('class'=>'form-control')); ?>
			</div>
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							// 	));
								?>
								<?php echo $form->textField($model,'passport_startdate',array('class'=>'form-control')); ?>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								// 	));
									?>
									<?php echo $form->textField($model,'passport_enddate',array('class'=>'form-control')); ?>
								</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															...
															echo $form->radioButtonList($model,'department_year',
																array('0'=>'-','1'=>'1 Tahun','3'=>'3 Tahun','5'=>'5 Tahun','10'=>'10 Tahun'),
																array(
																	'template'=>'{input}{label}',
																	'separator'=>'',
																	'labelOptions'=>array(
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																...
																// 	));
																	?>
																	<?php echo $form->textField($model,'rptka_enddate',array('class'=>'form-control')); ?>
																</div>
															...
															<div class="form-group">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		...
																		// 	));
																			?>
																			<?php echo $form->textField($model,'imta_date',array('class'=>'form-control')); ?>
																		</div>
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			...
																			// 	));
																				?>
																				<?php echo $form->textField($model,'kitas_startdate',array('class'=>'form-control')); ?>
																			</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-8">
																				...
																				// 	));
																					?>
																					<?php echo $form->textField($model,'kitas_enddate',array('class'=>'form-control')); ?>
																				</div>
