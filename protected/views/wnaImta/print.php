...
<div class="kotak">
	...
	<BR> <BR>
		...
		<!-- <div class="info">NOMOR : 569/&ensp; &ensp; &ensp; &ensp;-<?php echo substr($model->no_registration, 3); ?></div> -->
			<div class="info">NOMOR : 569/&ensp; &ensp; &ensp; &ensp;-<?php echo substr($model->no_registration, 3, 4).substr($model->no_registration, 10, 6); ?></div>
	...
	<div class="kotak" style="text-align:justify;font-size:18px;line-height:20px;">
		<div class="isi">
			...
			<BR> <BR> <p>
				...
				&ensp;
				&ensp;
				Berdasarkan Surat dari PT. <?php echo substr($model->Company->name, 0,-4); ?>, Nomor : <?php echo $model->no_report; ?> Tanggal <?php echo $model->date_report; ?>, Perihal Lapor Keberadaan Tenaga Kerja Warga Negara Asing Pendatang (TKWNAP) dengan ini, Kepala Dinas Tenaga Kerja Kabupaten Bandung menerangkan bahwa:
			</p>
			<p>
				<div class="jadwal">
					<table>
...
<BR>
	<BR>
		<div class="kotak">
			<div class="kiri">
				<BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <BR> <b><u>Tembusan</u></b> disampaikan kepada : <br>
					<small>
