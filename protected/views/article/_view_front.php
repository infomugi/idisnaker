...
<article>
	...
	<figure>
		<a class="zoomy" href="<?php echo Yii::app()->baseUrl; ?>/image/posting/big/<?php echo CHtml::encode($data->image); ?>"><img src="<?php echo Yii::app()->baseUrl; ?>/image/posting/small/<?php echo CHtml::encode($data->image); ?>" alt="<?php echo CHtml::encode($data->tags); ?>" width="740" height="303"></a>
	</figure>
</article>
