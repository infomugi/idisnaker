...
<article>
	...
	<figure>
		<a class="zoomy" href="<?php echo Yii::app()->baseUrl; ?>/image/posting/big/<?php echo CHtml::encode($model->image); ?>"><img src="<?php echo Yii::app()->baseUrl; ?>/image/posting/small/<?php echo CHtml::encode($model->image); ?>" alt="<?php echo CHtml::encode($model->tags); ?>" width="740" height="303"></a>
	</figure>	
